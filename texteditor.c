//Text editor using two stack model
...
//function to push element at top of stack
...
// function to examine the top element
void ExamineTop()
{
    if (leftisempty() == 1)
...
// function to move cursor to left
...
// function to move cursor to right
...
// function to move cursor to required position
...
//funuction to delete character in the right stack
int deleteCharacter()
{
    if (rightisempty() == 1)
        return 0;
...
//funuction to delete character in the left stack
...
// function to find and replace char from text added
